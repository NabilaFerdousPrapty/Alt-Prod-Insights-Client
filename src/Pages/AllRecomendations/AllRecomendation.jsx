          ...
          allQueries.map((query) => (
            ...
            >
              ...
              <div className="flex items-center px-6 py-3">
                ...
                <h1 className="mx-3 text-lg font-semibold text-purple-800">
                  {query.productName}
                </h1>
              </div>
              ...
              <div className="px-6 py-4">
                ...
                <p className="py-2 text-purple-300">{query.reason}</p>
                ...
                <div className="flex items-center mt-4 text-purple-500">
                  ...
                  <h1 className="px-2 text-sm">
                    user posted: {query.userName} with email {query.userEmail}
                  </h1>
                </div>
                ...
                <div className="flex items-center mt-4 text-purple-400">
                  ...
                  <h1 className="px-2 text-sm">
                    Recommender name: {query.RecommenderName}
                  </h1>
                </div>
                ...
                <div className="flex items-center mt-4">
                  ...
                  <h1 className="px-2 text-sm">
                    Recommender Email {query.RecommenderEmail}
                  </h1>
                </div>
              </div>
            </div>
...
export default AllRecomendation;
